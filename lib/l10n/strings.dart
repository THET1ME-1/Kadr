...
const Map<String, Map<String, String>> _strings = {
  ...
  'bio_works': {'ru': 'Главные проекты', 'en': 'Main projects'},
  'bio_trivia': {'ru': 'Интересный факт', 'en': 'Fun fact'},
  'read_more': {'ru': 'Читать дальше', 'en': 'Read more'},
  'read_less': {'ru': 'Свернуть', 'en': 'Show less'},
  'person_acting': {'ru': 'Актёр', 'en': 'Actor'},
  'person_writing': {'ru': 'Сценарист', 'en': 'Writer'},
  'person_producing': {'ru': 'Продюсер', 'en': 'Producer'},
  'person_watched_n': {'ru': 'Смотрели {n}', 'en': '{n} watched'},
  ...
  'share_card_title': {'ru': 'Поделиться карточкой', 'en': 'Share a card'},
  'share_style_poster': {'ru': 'Афиша', 'en': 'Poster'},
  'share_style_ticket': {'ru': 'Билет', 'en': 'Ticket'},
  'share_style_story': {'ru': 'Сторис', 'en': 'Story'},
  'share_style_quiet': {'ru': 'Тихая', 'en': 'Quiet'},
  'share_texture_frame': {'ru': 'Кадр', 'en': 'Film still'},
  'share_texture_film': {'ru': 'Плёнка', 'en': 'Film strip'},
  'share_texture_letters': {'ru': 'Буквы', 'en': 'Lettering'},
  'share_texture_title': {'ru': 'Чем занят фон', 'en': 'Background'},
  'share_hint_size': {
    'ru': 'Сохранится в PNG {w} px по ширине',
    'en': 'Saves as PNG, {w} px wide',
  },
  'share_hint_texture': {
    'ru': 'Удержание на стиле — выбрать фон',
    'en': 'Hold a style to pick its background',
  },
  'share_ticket_watched': {'ru': 'Просмотрено', 'en': 'Watched'},
  'share_ticket_planned': {'ru': 'В планах', 'en': 'Planned'},
  'share_field_score': {'ru': 'Оценка', 'en': 'Rating'},
  'share_field_date': {'ru': 'Дата', 'en': 'Date'},
  'share_field_view': {'ru': 'Просмотр', 'en': 'View'},
  'share_view_nth': {'ru': '{n}-й просмотр', 'en': 'view #{n}'},
  'share_view_short': {'ru': '{n}-й', 'en': '#{n}'},
  'share_in_list': {'ru': 'В списке', 'en': 'In list'},
  'share_my_score': {'ru': 'Моя оценка', 'en': 'My rating'},
  'share_failed': {
    'ru': 'Не получилось собрать картинку',
    'en': 'Could not build the image',
  },
  ...
  // ------------------------------- Рецензии -------------------------------
  'activity_reviewed': {
    'ru': 'написал рецензию на «{title}»',
    'en': 'reviewed “{title}”',
  },
  'friend_reviews': {'ru': 'Рецензии · {n}', 'en': 'Reviews · {n}'},
  'rv_add': {'ru': 'Добавить', 'en': 'Add'},
  'rv_add_pro': {'ru': 'Сильная сторона', 'en': 'Strong point'},
  'rv_add_con': {'ru': 'Слабая сторона', 'en': 'Weak point'},
  'rv_add_hint': {'ru': 'Своими словами', 'en': 'In your own words'},
  'rv_avg_is': {'ru': 'По пунктам выходит', 'en': 'Your criteria average'},
  'rv_avg_short': {'ru': 'среднее {v}', 'en': 'average {v}'},
  'rv_body_hint': {
    'ru': 'Что осталось с вами после титров? С чего фильм начинается, где проседает, чем цепляет. Работает Markdown: **жирный**, _курсив_, > цитата, ||спойлер||.',
    'en': 'What stayed with you after the credits? How it opens, where it sags, what hooks you. Markdown works: **bold**, _italic_, > quote, ||spoiler||.',
  },
  'rv_continue': {'ru': 'Продолжить', 'en': 'Continue'},
  'rv_pros': {'ru': 'Сильное', 'en': 'Strengths'},
  'rv_cons': {'ru': 'Слабое', 'en': 'Weaknesses'},
  'rv_criteria': {'ru': 'По пунктам', 'en': 'By criteria'},
  'rv_criteria_hint': {
    'ru': 'Нажмите на число, чтобы ввести его точно. Удержание сбрасывает пункт.',
    'en': 'Tap a number to type it exactly. Hold to clear it.',
  },
  'rv_customize': {'ru': 'Настроить', 'en': 'Customize'},
  'rv_customize_title': {'ru': 'Пункты разбора', 'en': 'Review criteria'},
  'rv_customize_sub': {
    'ru': 'Выберите, что оценивать. Набор сохранится для следующих рецензий.',
    'en': 'Pick what to rate. The set stays for your next reviews.',
  },
  'rv_delete': {'ru': 'Удалить рецензию', 'en': 'Delete review'},
  'rv_delete_q': {'ru': 'Удалить рецензию?', 'en': 'Delete this review?'},
  'rv_delete_sub': {
    'ru': 'Текст, оценки по пунктам и вердикт пропадут. Общая оценка фильма останется.',
    'en': 'The text, criteria scores and verdict will be gone. Your overall rating stays.',
  },
  'rv_divergence': {
    'ru': 'Больше всего вы расходитесь в пункте «{crit}»: {name} — {a}, вы — {b}.',
    'en': 'You differ most on {crit}: {name} gave {a}, you gave {b}.',
  },
  'rv_draft_saved': {'ru': 'Черновик сохранён', 'en': 'Draft saved'},
  'rv_editor_title': {'ru': 'Рецензия', 'en': 'Review'},
  'rv_empty': {
    'ru': 'Поставьте оценку по пунктам, вердикт или напишите пару строк',
    'en': 'Add a criterion score, a verdict or a couple of lines',
  },
  'rv_fmt_bold': {'ru': 'Жирный', 'en': 'Bold'},
  'rv_fmt_italic': {'ru': 'Курсив', 'en': 'Italic'},
  'rv_fmt_heading': {'ru': 'Заголовок', 'en': 'Heading'},
  'rv_fmt_quote': {'ru': 'Цитата', 'en': 'Quote'},
  'rv_fmt_list': {'ru': 'Список', 'en': 'List'},
  'rv_fmt_strike': {'ru': 'Зачёркнутый', 'en': 'Strikethrough'},
  'rv_fmt_rule': {'ru': 'Разделитель', 'en': 'Divider'},
  'rv_fmt_term': {'ru': 'Термин', 'en': 'Term'},
  'rv_fmt_help': {'ru': 'Как оформлять', 'en': 'Formatting'},
  'rv_help_sub': {
    'ru': 'Пишите знаки прямо в тексте или жмите кнопки на панели.',
    'en': 'Type the marks right in the text or use the toolbar.',
  },
  'rv_friend': {'ru': 'Друг', 'en': 'Friend'},
  'rv_gate_title': {
    'ru': 'В рецензии есть спойлеры',
    'en': 'This review has spoilers',
  },
  'rv_gate_sub': {
    'ru': 'Автор предупредил: текст раскрывает сюжет. Если ещё не смотрели, отложите до просмотра.',
    'en': 'The author warns the text gives the plot away. Haven’t watched it yet? Save it for later.',
  },
  'rv_gate_open': {'ru': 'Показать текст', 'en': 'Show the text'},
  'rv_glossary': {'ru': 'Словарь критика', 'en': 'Critic’s glossary'},
  'rv_glossary_sub': {
    'ru': 'Термин встанет в текст с пунктиром. Друг нажмёт на него и прочтёт определение на своём языке.',
    'en': 'The term goes into your text with a dotted underline. A friend taps it to read the definition in their language.',
  },
  'rv_glossary_search': {'ru': 'Найти термин', 'en': 'Find a term'},
  'rv_glossary_all': {'ru': 'Все', 'en': 'All'},
  'rv_insert': {'ru': 'Вставить', 'en': 'Insert'},
  'rv_keep_draft': {'ru': 'Оставить черновиком', 'en': 'Keep as draft'},
  'rv_kind_movie': {'ru': 'фильм', 'en': 'film'},
  'rv_kind_series': {'ru': 'сериал', 'en': 'series'},
  'rv_label_friend': {'ru': 'Рецензия · {title}', 'en': 'Review · {title}'},
  'rv_label_mine': {
    'ru': 'Моя рецензия · {title}',
    'en': 'My review · {title}',
  },
  'rv_minutes': {'ru': '{n} мин', 'en': '{n} min'},
  'rv_read_min': {'ru': '{n} мин чтения', 'en': '{n} min read'},
  'rv_mode_edit': {'ru': 'Правка', 'en': 'Edit'},
  'rv_mode_preview': {'ru': 'Просмотр', 'en': 'Preview'},
  'rv_next': {'ru': 'Далее', 'en': 'Next'},
  'rv_open_mine': {'ru': 'Открыть мою рецензию', 'en': 'Open my review'},
  'rv_overall': {'ru': 'Общая оценка', 'en': 'Overall score'},
  'rv_preview_empty': {
    'ru': 'Здесь появится рецензия, как её увидят читатели.',
    'en': 'Your review will appear here the way readers see it.',
  },
  'rv_preview_friends': {
    'ru': 'Так рецензию увидят друзья',
    'en': 'How friends will see it',
  },
  'rv_preview_me': {
    'ru': 'Так выглядит рецензия',
    'en': 'How your review looks',
  },
  'rv_preview_full': {'ru': 'Открыть целиком', 'en': 'Open full page'},
  'rv_publish': {'ru': 'Опубликовать', 'en': 'Publish'},
  'rv_published': {'ru': 'Рецензия опубликована', 'en': 'Review published'},
  'rv_save': {'ru': 'Сохранить', 'en': 'Save'},
  'rv_saved': {'ru': 'Рецензия сохранена', 'en': 'Review saved'},
  'rv_read_full': {'ru': 'Читать целиком', 'en': 'Read in full'},
  'rv_remove': {'ru': 'Убрать', 'en': 'Remove'},
  'rv_reply': {
    'ru': 'Ответить своей рецензией',
    'en': 'Reply with your review',
  },
  'rv_set_avg': {'ru': 'Поставить {v}', 'en': 'Use {v}'},
  'rv_share': {'ru': 'Видят друзья', 'en': 'Friends can see it'},
  'rv_share_sub': {
    'ru': 'Рецензия появится в их ленте и в вашем профиле',
    'en': 'It shows up in their feed and on your profile',
  },
  'rv_share_login': {
    'ru': 'Войдите в аккаунт, чтобы делиться с друзьями',
    'en': 'Sign in to share with friends',
  },
  'rv_share_text': {'ru': 'Поделиться', 'en': 'Share'},
  'rv_show_all': {'ru': 'Показать все ({n})', 'en': 'Show all ({n})'},
  'rv_spoiler': {'ru': 'Спойлер', 'en': 'Spoiler'},
  'rv_spoiler_hidden': {
    'ru': 'Скрытый спойлер, нажмите, чтобы открыть',
    'en': 'Hidden spoiler, tap to reveal',
  },
  'rv_spoiler_mask': {'ru': '[спойлер]', 'en': '[spoiler]'},
  'rv_spoilers': {'ru': 'В тексте спойлеры', 'en': 'Text has spoilers'},
  'rv_spoilers_sub': {
    'ru': 'Друзья увидят текст только после нажатия',
    'en': 'Friends see the text only after a tap',
  },
  'rv_status_draft': {'ru': 'Черновик', 'en': 'Draft'},
  'rv_status_friends': {'ru': 'Видят друзья', 'en': 'Friends can see'},
  'rv_status_private': {'ru': 'Только вы', 'en': 'Only you'},
  'rv_step_rate': {'ru': 'Оценка', 'en': 'Rating'},
  'rv_step_text': {'ru': 'Текст', 'en': 'Text'},
  'rv_step_publish': {'ru': 'Публикация', 'en': 'Publish'},
  'rv_suggestions': {'ru': 'Подсказки', 'en': 'Suggestions'},
  'rv_tap_to_reveal': {'ru': 'Нажмите, чтобы открыть', 'en': 'Tap to reveal'},
  'rv_title_hint': {'ru': 'Заголовок рецензии', 'en': 'Review headline'},
  'rv_to_text': {'ru': 'К тексту', 'en': 'On to the text'},
  'rv_toolbar': {'ru': 'Разметка', 'en': 'Formatting'},
  'rv_untitled': {'ru': 'Без заголовка', 'en': 'Untitled'},
  'rv_verdict': {'ru': 'Вердикт', 'en': 'Verdict'},
  'rv_verdict_hint': {
    'ru': 'по оценке подходит «{v}»',
    'en': 'your score suggests “{v}”',
  },
  'rv_words_one': {'ru': '{n} слово', 'en': '{n} word'},
  'rv_words_few': {'ru': '{n} слова', 'en': '{n} words'},
  'rv_words_many': {'ru': '{n} слов', 'en': '{n} words'},
  'rv_you': {'ru': 'Вы', 'en': 'You'},
  'rv_you_and': {'ru': 'Вы и {name}', 'en': 'You and {name}'},
  'crit_story': {'ru': 'Сюжет', 'en': 'Plot'},
  'crit_direction': {'ru': 'Режиссура', 'en': 'Direction'},
  'crit_acting': {'ru': 'Актёры', 'en': 'Acting'},
  'crit_visuals': {'ru': 'Картинка', 'en': 'Visuals'},
  'crit_sound': {'ru': 'Звук', 'en': 'Sound'},
  'crit_pace': {'ru': 'Темп', 'en': 'Pacing'},
  'crit_script': {'ru': 'Сценарий', 'en': 'Screenplay'},
  'crit_characters': {'ru': 'Персонажи', 'en': 'Characters'},
  'crit_atmosphere': {'ru': 'Атмосфера', 'en': 'Atmosphere'},
  'crit_music': {'ru': 'Музыка', 'en': 'Music'},
  'crit_effects': {'ru': 'Спецэффекты', 'en': 'Effects'},
  'crit_editing': {'ru': 'Монтаж', 'en': 'Editing'},
  'crit_ending': {'ru': 'Финал', 'en': 'Ending'},
  'crit_humor': {'ru': 'Юмор', 'en': 'Humor'},
  'crit_originality': {'ru': 'Оригинальность', 'en': 'Originality'},
  'verdict_masterpiece': {'ru': 'Шедевр', 'en': 'Masterpiece'},
  'verdict_must': {'ru': 'Обязательно', 'en': 'Must-see'},
  'verdict_worth': {'ru': 'Стоит времени', 'en': 'Worth your time'},
  'verdict_niche': {'ru': 'На любителя', 'en': 'Acquired taste'},
  'verdict_miss': {'ru': 'Мимо', 'en': 'Skip it'},
  'term_group_story': {'ru': 'Сюжет', 'en': 'Story'},
  'term_group_camera': {'ru': 'Камера и монтаж', 'en': 'Camera & editing'},
  'term_group_sound': {'ru': 'Звук', 'en': 'Sound'},
  'term_group_genre': {'ru': 'Жанр и тон', 'en': 'Genre & tone'},
  'tag_twist': {'ru': 'Неожиданный финал', 'en': 'Surprise ending'},
  'tag_atmosphere': {'ru': 'Атмосфера', 'en': 'Atmosphere'},
  'tag_acting': {'ru': 'Игра актёров', 'en': 'Performances'},
  'tag_visuals': {'ru': 'Картинка', 'en': 'Visuals'},
  'tag_music': {'ru': 'Музыка', 'en': 'Music'},
  'tag_dialogues': {'ru': 'Диалоги', 'en': 'Dialogue'},
  'tag_tension': {'ru': 'Держит в напряжении', 'en': 'Keeps you on edge'},
  'tag_characters': {'ru': 'Живые персонажи', 'en': 'Characters feel real'},
  'tag_humor': {'ru': 'Юмор', 'en': 'Humor'},
  'tag_idea': {'ru': 'Сильная идея', 'en': 'Strong idea'},
  'tag_slow': {'ru': 'Затянуто', 'en': 'Drags'},
  'tag_predictable': {'ru': 'Предсказуемо', 'en': 'Predictable'},
  'tag_plotholes': {'ru': 'Дыры в сюжете', 'en': 'Plot holes'},
  'tag_weak_ending': {'ru': 'Слабый финал', 'en': 'Weak ending'},
  'tag_overacting': {'ru': 'Переигрывают', 'en': 'Overacting'},
  'tag_cgi': {'ru': 'Слабая графика', 'en': 'Weak CGI'},
  'tag_flat_characters': {'ru': 'Плоские персонажи', 'en': 'Flat characters'},
  'tag_cliches': {'ru': 'Штампы', 'en': 'Clichés'},
  'tag_boring': {'ru': 'Скучно', 'en': 'Boring'},
};
